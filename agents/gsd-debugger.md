...
<required_reading>
@$HOME/.hermes/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@$HOME/.hermes/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = $HOME/.hermes
                  → checks $HOME/.hermes/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/.hermes/get-shit-done
                  → writes to $HOME/.hermes/get-shit-done/hooks/
...
@$HOME/.hermes/get-shit-done/references/thinking-models-debug.md
...
- Read @$HOME/.hermes/get-shit-done/references/common-bug-patterns.md
