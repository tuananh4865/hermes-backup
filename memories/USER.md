...
- [project] correctly [HIGH]
- 2026-05-18: Review the conversation above and update two things:
**Memory**: who the user is. Did the user reve
- [model] claude [HIGH]
- [preference] bật auto-update thật sự cho Claude Code, có thể cài qua Homebrew thay vì npm. Nhưng thực ra không cần — em có thể update manual bất cứ lúc nào: [HIGH]
- [preference] phải lỗi [HIGH]
