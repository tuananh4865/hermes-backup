...
Key references:
- @$HOME/.hermes/get-shit-done/references/ui-brand.md (display patterns)
- @$HOME/.hermes/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/.hermes/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/.hermes/get-shit-done/USER-PROFILE.md"
...
```bash
cp "$HOME/.hermes/get-shit-done/USER-PROFILE.md" "$HOME/.hermes/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/.hermes/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/.hermes/get-shit-done/references/user-profiling.md`
...
Reference: @$HOME/.hermes/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/.hermes/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global HERMES.md" -- "Add profile to $HOME/.hermes/HERMES.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/.hermes/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at $HOME/.hermes/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to $HOME/.hermes/HERMES.md"
...
```bash
BACKUP_PATH="$HOME/.hermes/USER-PROFILE.backup.md"
```
...
Your profile:    $HOME/.hermes/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/.hermes/skills/gsd-dev-preferences/SKILL.md
  ✓ HERMES.md section       ./HERMES.md
  ✓ Global HERMES.md        $HOME/.hermes/HERMES.md
```
