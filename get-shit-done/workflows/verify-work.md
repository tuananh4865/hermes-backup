...
<template>
@$HOME/.hermes/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@$HOME/.hermes/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `$HOME/.hermes/get-shit-done/workflows/transition.md`.
...
- Follow @$HOME/.hermes/get-shit-done/workflows/diagnose-issues.md
