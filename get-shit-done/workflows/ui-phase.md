...
```markdown
Read $HOME/.hermes/agents/gsd-ui-researcher.md for instructions.
...
Template: $HOME/.hermes/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read $HOME/.hermes/agents/gsd-ui-checker.md for instructions.
