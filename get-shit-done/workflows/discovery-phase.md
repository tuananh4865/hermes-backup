...
See $HOME/.hermes/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.hermes/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.hermes/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.hermes/get-shit-done/templates/discovery.md
...
Use $HOME/.hermes/get-shit-done/templates/discovery.md.
