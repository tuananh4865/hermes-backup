...
<required_reading>
@$HOME/.hermes/get-shit-done/references/ai-frameworks.md
@$HOME/.hermes/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read $HOME/.hermes/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "$HOME/.hermes/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read $HOME/.hermes/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read $HOME/.hermes/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read $HOME/.hermes/agents/gsd-eval-planner.md for instructions.
