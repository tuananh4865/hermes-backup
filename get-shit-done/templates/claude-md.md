...
Template for project-root `HERMES.md` — auto-generated by `gsd-tools generate-claude-md`.
...
**Fallback text:**
```
No project skills found. Add skills to any of: `.hermes/skills/`, `.agents/skills/`, `.cursor/skills/`, or `.github/skills/` with a `SKILL.md` index file.
```

**Discovery behavior:**
- Scans `.hermes/skills/`, `.agents/skills/`, `.cursor/skills/`, `.github/skills/` for subdirectories containing `SKILL.md`
...
HERMES.md file and no profile section exists yet.
