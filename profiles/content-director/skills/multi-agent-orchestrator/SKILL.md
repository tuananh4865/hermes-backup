...
- **references/telegram-bot-to-bot-threads.md**: Telegram bot-to-bot thread routing — format `telegram:-1003764041476:603`, error states, setup requirements, privacy mode (2026-05-04)

### BOT-TO-BOT REQUIREMENTS (2026-05-04)
- **Privacy mode**: BOT MUST disable via @BotFather → /mybots → [bot] → Group Privacy → Disable
- **Format**: `telegram:-1003764041476:603` (negative chat_id + thread_id)
- **API timeout**: MiniMax causes retry loops — have fallback provider ready
