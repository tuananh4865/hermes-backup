...
> **Reusable starter template:** See `references/harvest-pattern-bank.md` for a real worked harvest (Claude Fable 5 → Hermes SOUL.md, 4 patterns, all verified). The bank includes a fill-in template for new harvests and a "what was rejected" section to prevent re-imports.
