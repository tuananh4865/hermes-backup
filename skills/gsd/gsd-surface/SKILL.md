...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `$HOME/.hermes/skills/.gsd-surface.json`
...
```bash
# Hermes Agent
RUNTIME_CONFIG_DIR=$HOME/.hermes/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=$HOME/.hermes/commands/gsd
...
<execution_context>
Surface state file: `$HOME/.hermes/skills/.gsd-surface.json`
Install profile marker: `$HOME/.hermes/skills/.gsd-profile`
Engine module: `$HOME/.hermes/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `$HOME/.hermes/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
