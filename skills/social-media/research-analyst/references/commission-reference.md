# TikTok Shop Vietnam — Commission & Fee Reference
**Date:** May 2026 | **Source:** Research session 2026-05-09

## Platform Fee Structure (May 2026)

| Fee Type | Rate | Notes |
|----------|------|-------|
| Platform Commission | 12.5-14.5% | Marketplace vs Mall |
| Transaction Fee | 5% per order | Post-discount price |
| Order Processing | ₫3,000/order | Fixed |
...
## Commission by Category (Vietnam)

| Category | Avg Commission | Range |
|----------|---------------|-------|
| Health & Wellness | 16.38% | 12-25% |
| Menswear & Underwear | 14.24% | 10-20% |
| Beauty & Personal Care | 13.21% | 10-20% |
| Women’s Fashion | 13.03% | 10-18% |
| Tech Accessories | 12-15% | 8-30% |
| Home Goods | 10-15% | 8-20% |

## Commission Math (Survival Rules)

### Rule: High-commission low-price > Low-commission high-price
```
₫20,000 × 20% = ₫4,000 earnings
₫40,000 × 8%  = ₫3,200 earnings
```
→ ₫20K item at 20% EARNS MORE than ₫40K item at 8%

### Survival Rule
**Only products with 60%+ gross margin OR 15%+ commission can survive.**

### Bundle Strategy (Beat ₫3,000/order fee)
| Format | Price | Fee % | Effective |
|--------|-------|-------|-----------|
