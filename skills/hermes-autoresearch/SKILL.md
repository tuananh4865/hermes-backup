...
- `references/self-improving-agents-may-2026.md` — **10 NEW arXiv techniques** (May 9): ERL, ICPO, Trajectory Memory, Hyperagents, MARS, RetroAgent, GEA, POLARIS, Self-Optimizing Multi-Agent, Hierarchical Self-Evolving.
