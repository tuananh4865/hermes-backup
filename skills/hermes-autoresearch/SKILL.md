...
- `references/self-improving-agents-2026.md` — **AI agent self-improvement techniques** (2026-05-08): 10 techniques — Multi-Agent Reflexion, HyperAgents, A2A/MCP/ACP protocols, Trace Learning, Self-Debugging, SWE-RL, Fallback Chain.
- `references/self-improving-agents-may-2026.md` — **10 NEW arXiv techniques** (2026-05-09): ERL, ICPO, Trajectory Memory, Hyperagents, MARS, RetroAgent, GEA, POLARIS, Self-Optimizing Multi-Agent, Hierarchical Self-Evolving.
