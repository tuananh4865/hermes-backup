...
**Autoresearch 2026-05-13 — DONE**

**Summary:**
- ✅ Wiki: 3638 files, 0 issues (wiki_lint --fast PASSED)
- ✅ Skills: 138 skills, SHS = 0
- ✅ Gen Z slang: verified fresh (learned-about-tuananh.md updated 2026-05-11)
- ✅ Workers: last ran May 10 (orchestrator not firing — documented)
- ✅ Git: Committed (8f85a6c0a)

**Tonight's Research: 12 NEW Self-Improving Agent Techniques**

| # | Technique | Key Innovation |
|---|----------|----------------|
| 1 | ERL | Trajectory → reusable heuristics, +7.8% Gaia2 |
| 2 | Polaris | Gödel agent, policy-level self-repair for 7B |
| 3 | Self-Consolidation | Contrastive reflection + latent space distillation |
| 4 | ReflexiCoder | RL-zero self-debugging, no external oracles |
| 5 | RetroAgent | Dual intrinsic feedback + SimUtil-UCB retrieval |
| 6 | MARS | Single-cycle self-improvement (principle + procedural) |
| 7 | AEL | Two-timescale bandit + LLM reflection |
| 8 | DeepVerifier | Test-time verification scaling, DRA Failure Taxonomy |
| 9 | ICPO | In-context policy optimization, ME-ICPO |
| 10 | MemPO | Self-memory policy optimization, 67% token reduction |
| 11 | EMPO² | Hybrid on/off-policy RL, 128.6% over GRPO |
| 12 | MCMA | Meta-cognitive memory abstraction via DPO |

**Key Insight:** Self-improvement paradigm has SHIFTED from heuristic-based to RL-trained policies. The bottleneck is self-diagnosis (how to use experience), NOT experience accumulation. Memory operations (Create/Read/Update/Delete) becoming standard callable tools trained via GRPO/PPO.

**Saved to:** `wiki/references/self-improving-agents-may-2026.md`
