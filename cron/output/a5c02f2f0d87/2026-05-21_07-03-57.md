...
## Autoresearch Nightly Report — 2026-05-21
...
|-----------|--------|-------|
| Wiki | ✅ Clean | `wiki_lint --fast`: 0 issues |
| Skills | ✅ SHS=0 | 236 skills healthy |
| Workers | ⚠️ DEAD | 7+ days stale — Content Creator last May 14, Research Agent May 12 |

---

### Focus Tonight: Goal Decomposition + Planning (#11, #12)

**6 NEW techniques documented:**

| Technique | Source | Key Insight |
|-----------|--------|-------------|
| **TDP** (Task-Decoupled Planning) | arXiv:2601.07577 | DAG of sub-goals, 60% context reduction |
| **DELTA** | delta-llm.github.io | Autoregressive sub-goal decomposition for robots |
| **Flare** | arXiv:2601.22311 | Planning-level behavior improvement across benchmarks |
| **PIVOT** | arXiv:2605.11225 | Travel/Shopping planning benchmark, plan adherence measurement |
| **Policy Decompositions** | arXiv:2605.06957 | Hierarchical task decomposition for LLM agents |
| **Plan-to-Action** | arXiv:2604.12147 | 16,991 trajectories analyzed — agents follow plans ~70% |

**Key finding:** TDP pattern (Planner + Executor with scoped contexts) directly applicable to Hermes multi-agent orchestration.

---

### Gen Z Slang

**Workers dead → web search fallback.** No new slang found (May 21 search = same terms from Mar-Jun 2026: Xịn sò, Kèo, Quẩy, Tạch, Tấu hài, Hết nước chấm). Wiki Gen Z section (May 18) is current. **No sync needed.**

---

### Hermes Agent Updates

- **GitHub:** 157.2K+ stars, global rank #46
- **Latest:** v0.14 "Foundation Release" — 180x browser automation (CDP), live session handoffs, Windows beta, LINE/SimpleX/Teams
- **Community:** 7,309 members — top request: swarm agents tutorials + kanban + conductor documentation

---

### Git Commit
`42e46f54b` — 6 goal decomposition techniques, wiki clean, SHS=0, workers dead

---

**Recommendation:** Workers need manual restart (cron re-enable). TDP pattern could improve orchestrator task decomposition.
