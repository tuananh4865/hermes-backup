...
| Metric | Value |
|--------|-------|
| GitHub Stars | **158K+** (↑700 in 1 day) |
| Latest Version | v0.15.2 hotfix (v2026.5.29.2) |
| Major Release | v0.15.0 "Velocity Release" (May 28) |

**Top 10 Community Use Cases Found:**
1. **Personal Assistant** — Claude for chat, Hermes 24/7 on mini PC for real-world tasks
2. **Weather Trading Bot** — $100 → $216 in 48 hours via automated market monitoring
3. **Research Agent** — Daily brief across Discord/Slack/Notion/Obsidian
4. **UGC Ad Studio** — Product URL → complete ad brief in 4 minutes
5. **12-Agent Dev Team** — @Teknium runs 12 parallel Hermes instances to build Hermes itself
6. **Production Solar Sales Ops** — iMessage gateway managing 8-rep team, 26-page wiki
7. **Autonomous Novel** — 19 chapters, 79,456 words, audiobook + website
8. **Polymarket Trading** — 4-layer parallel on-chain monitoring
9. **Second Brain** — Obsidian integration, 794+ upvotes
10. **Home Lab Monitoring** — Validator watching + Telegram alerts

**Gen Z Slang:** No new terms (web search finds only already-documented terms, workers permanently deleted May 25)

**Git:** Committed to autoresearch repo ✅, wiki log updated + pushed ✅
