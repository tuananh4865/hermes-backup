...
# Hermes Agent X Research — June 7, 2026

## 🔥 BREAKING: v0.16.0 "The Surface Release" — JUST DROPPED

**Release Date:** June 5, 2026 (22 hours ago)
**GitHub:** 874 commits, 542 merged PRs since v0.15.2

### Key Features:
1. **Native Desktop App** — macOS, Windows, Linux (100+ PRs, 159 contributors)
2. **Remote Gateway Connection** — Connect to remote Hermes via Settings → Gateway
3. **Web Management Panel** — New admin interface
4. **Native Windows Support** — No WSL required
5. **`hermes update` Flow** — Streamlined updates

**Community:** 686 likes on announcement. *"hermes is no longer just a CLI agent"*

---

## 🖥️ Hermes Desktop — Launched June 3

Native TypeScript app for installing, configuring, chatting with Hermes. Streaming tool output, session management, persistent memory. MIT License.
...
Nous working with NVIDIA for RTX AI hardware compatibility. RTX Spark (128GB unified memory) — *"Everyone will run a team of AI Agents on their PC by end of 2026"*
...
| Feb 25 | Launch |
| Apr 20 | 100K (7 weeks) |
| May 10 | Overtake OpenClaw |
| May 27 | 157K |
| **Jun 7** | **176K+** (~19K in 11 days) |

---

## Gen Z Slang

**Workers permanently deleted** (May 25) — web search fallback only.

Web finds already-documented terms: Xịn sò, Toang, Gato, Đỉnh, Lọ. Fresh slang (like "Nam thư" from May 5) doesn't appear in web results. **Slang list may need refresh via worker recovery.**

---

## Wiki Updated
- ✅ `references/x-research-hermes-2026-06-07.md` (new)
- ✅ `index.md` (Hermes X Research section)
- ✅ `log.md`
- ✅ Git committed

**Wiki health:** 0 issues (143 files)
