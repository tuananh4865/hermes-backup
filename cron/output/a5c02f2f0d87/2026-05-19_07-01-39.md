...
# Hermes Agent X Research — 2026-05-19

## Overview
- **Total mentions found:** ~50+ (web + social)
- **Date range:** Last 7 days (May 12-19, 2026)
- **Sentiment:** Strongly positive (community enthusiasm high)
- **GitHub Stars:** ~156,384 (↑1,697 in 1 day since May 18's 154,687)
...
| Metric | Value |
|--------|-------|
| Stars | **156,384** (fastest 100K in GitHub history) |
| Forks | 25,147 |
| Open Issues | 12,169 |
| Contributors | 390 |
| Latest Release | v2026.5.16 (May 16, 2026) |
| Last Push | May 18, 2026 @ 23:10 |

---

## Top Use Cases (by frequency)

1. **Research & Web Automation** — Browser control + AI reasoning (most discussed)
2. **Personal AI Assistant** — Cross-platform memory, always-on tasks
3. **Coding Agent** — Dev workflows, PR review, codebase navigation
4. **Jailbreaking/Unrestricted AI** — Obliterus skill + self-improvement loop
5. **Multi-language Content** — Video generation in Mandarin, cross-lingual TTS
6. **Enterprise/Multi-user** — Shared memory across teams via Telegram/Discord

---

## New Discoveries This Session

### 1. NVIDIA Blog Feature (May 13, 2026) 🔥
**"Hermes Unlocks Self-Improving AI Agents, Powered by NVIDIA RTX"**
- Hermes crossed **140,000 GitHub stars in under 3 months**
- **Most used agent in the world** according to OpenRouter
- Recommended hardware: **NVIDIA RTX PCs, RTX PRO workstations, DGX Spark**
- Runs great with **Qwen 3.6 via llama.cpp, LM Studio, Ollama**
- DGX Spark ideal for sustained all-day agentic workflows

**Key quote:** *"Agents like Hermes are built to run continuously — responding to requests, planning multistep tasks, executing autonomously and self-improving."*

**Action item:** Update Anh's setup notes if RTX/hardware recommendations are relevant for Vietnam market.

### 2. v2026.5.16 Release (May 16)
- Latest release, specific features not detailed in results
- Follows v0.12.0 "Curator Release" pattern of major quality-of-life improvements

### 3. Nous Research News
- **EvoMap vs Nous Research (April 18):** China-based EvoMap accused Nous of copying code, changed AI Agent license — appears to be a competitor dispute
- **DeepHermes-3 (August 2025):** Launched as "unrestricted" model outperforming ChatGPT

### 4. Dev.to Overview (April 29)
- Comprehensive explainer on Hermes as persistent AI agent
- Good reference for new user onboarding content
- Dev.to = developer community credibility
...
| vs | What People Say |
|----|-----------------|
| **OpenClaw** | Hermes growing faster; OpenClaw peaked March, declining. Some calling Hermes "OpenClaw killer." |
| **AutoGPT** | "Switched from AutoGPT. Hermes just works and the Telegram integration means I can use it anywhere." |
| **ChatGPT** | DeepHermes-3 (Aug 2025) claimed to outperform without restrictions |
| **PI Agent** | Browser Harness integration enables similar browser automation capability |

---

## Hermes Agent Ecosystem Growth

### Community Tools Mentioned:
- **computer-use-linux** — Linux desktop-control MCP server with AT-SPI accessibility trees
- **HermesClaw** — Community WeChat bridge (run Hermes + OpenClaw on same WeChat account)
- **Hermes Atlas** (hermesatlas.com) — Community map of 100+ tools/skills/integrations
- **browser-harness** — Thin self-healing harness for browser automation (creators offer Mac Mini bounty for finding non-working tasks)

### Skills Ecosystem:
- agentskills.io — Community skill hub (portable, shareable)
- Curator (v0.12.0) — Auto-grades/consolidates/prunes skills on 7-day cycle
- "Obliterus" — Jailbreaking skill that sparked viral discussion

---

## Technical Insights

### Multi-Platform Expansion (v0.9.0+):
- Now covers **16 messaging platforms**: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, Mattermost, Email, SMS, DingTalk, Feishu, WeCom, BlueBubbles (iMessage), WeChat, Home Assistant, Webhooks
- Chinese messaging ecosystem covered end-to-end (WeChat + WeCom)

### Research-Ready Features:
- Batch trajectory generation
- Atropos RL environments
- Trajectory compression for training next-gen tool-calling models
- Built by model trainers (Nous Research behind Hermes, Nomos, Psyche models)
...
## Action Items for Hermes (Anh's Setup)

1. **Consider NVIDIA RTX integration** — If Anh has RTX hardware, Hermes + Qwen 3.6 via LM Studio is officially recommended combo
2. **Monitor EvoMap situation** — If Nous Research faces IP challenges, may affect Hermes licensing trajectory
3. **Explore Browser Harness** — Next-level browser automation for TikTok content research
4. **Skills Curator health** — Verify Curator is running on Anh's instance and grading skills properly
...
| Account | Relevance |
|---------|-----------|
| @teknium1 | Top Hermes contributor (2,500+ commits) |
| Nous Research | Official account, releases + company news |
| Hermes Atlas | Community ecosystem tracker |

---

## Summary

Hermes Agent continues **meteoric growth** — nearly 157K stars, ~1,700 new stars/day. The NVIDIA blog post (May 13) was a major credibility milestone, cementing Hermes as "most used agent in world per OpenRouter." The community ecosystem (skills, MCP servers, WeChat bridges) is expanding rapidly. The Curator release (v0.12.0) and subsequent v2026.5.x releases show the team is focusing on **quality-of-life improvements** (skill management, memory optimization) rather than just features.

**Key takeaway for Anh:** Your setup is running a globally-trending, NVIDIA-recommended AI agent platform. The self-improvement loop (ByteRover memory + skill curation) is exactly the kind of autonomous capability that makes Hermes different from stateless chatbots.
