...
# Hermes Agent X Research — June 12, 2026

## Overview
- **Total mentions found**: 50+ results
- **GitHub Stars**: **176K+** (up from ~157K on May 29)
- **Sentiment**: Strongly positive — excitement around v0.16 desktop app

---

## 🚀 Major News: v0.16 "Surface Release" (June 2, 2026)

**Built across 100 PRs + 159 contributors**

### Key Features:
| Feature | Description |
|---------|-------------|
| **Native Desktop App** | macOS, Windows, Linux |
| **Browser Admin Panel** | Web-based dashboard |
| **Remote Gateway Connections** | Connect to remote Hermes backends |
| **Fuzzy Model Picker** | Easier model selection |
| **`/undo` Command** | New across all interfaces |
| **Simplified Chinese Desktop UI** | Localization expansion |
| **Leaner Default Skills** | Reduced default skill bundle |

### Community Reactions:
- **"Agents are moving from CLI demos into real operating surfaces"** — LinkedIn
- **"Hermes v0.16 is HUGE!"** — Multiple YouTube channels
- **"v0.16 AI Agent Update Is Bigger Than You Think"** — Reddit

---

## 🤝 NVIDIA Partnership — CONFIRMED

**NVIDIA Blog (May 13)**: "Hermes Unlocks Self-Improving AI Agents, Powered by NVIDIA RTX"

- Hermes brings new class of agents to NVIDIA RTX PCs and DGX systems
- RTX AI Garage partnership
- "At Nous, we expect tasks to increasingly run on device as personal agents" — May 31 Microsoft partnership article

---

## 🆕 New Capabilities

### Self-Evolution with DSPy + GEPA (May 6)
- Automatically evolve skill files based on real execution traces
- No GPU needed — just API calls

### Third-Party Hermes Desktop
- @hasantoxr wrapped Hermes in GUI — "makes Hermes accessible to normal people"
- First major third-party ecosystem project

### X Premium + Grok Integration
- Working via `xurl` skill
- Setup guide posted by xai team (May 19)
...
| Metric | Value |
|--------|-------|
| **X Community** | 7,309+ members |
| **GitHub Stars** | 176K+ |
| **Contributors (v0.16)** | 159 |
| **PRs (v0.16)** | 100 |
| **Release velocity** | v0.14 (May 16) → v0.15 (May 28) → v0.16 (June 5) |

---

## 🔧 Action Items

1. **Upgrade to v0.16** — Native desktop app is game-changing
2. **Try `/undo` command** — New in v0.16
3. **Explore self-evolution** — DSPy + GEPA for autonomous skill improvement
4. **Consider VPS deployment** — £4 tutorial available

---

## 📁 Files Updated

- `queries/x-research-hermes-2026-06-12.md` — New research doc
- `index.md` — Updated Hermes X Research section
- `log.md` — Logged June 12 research

**Git commit**: `30a70fd` — X research June 12: 176K stars, v0.16 Surface Release, NVIDIA partnership confirmed, 7,309 X members
