...
## Autoresearch Nightly Report — 2026-06-03

### System Status
- **Wiki:** ✅ Clean (0 issues, 241 files checked)
...
### Tonight's Research: 3 NEW arXiv Techniques

**Total self-improvement techniques documented: 31** (was 28)

| Technique | arXiv | Key Metric | Hermes Applicability |
|-----------|-------|------------|---------------------|
| **STV** (Self-Trained Verification) | 2605.30290 | 14× on hard math, breaks RLVR plateau | **HIGH** — verification bottleneck |
| **AgentFactory** | 2603.18000 | Executable subagent code > textual | **HIGH** — skill creation |
| **Native Evolution** | 2604.18131 | +20% WebVoyager/WebWalker, reward-free | **HIGH** — autonomous learning |

**Key insights:**
- **STV:** Verification is the bottleneck for self-improvement. Training verifier to catch self-generated errors unlocks both test-time (+14×) and training-time gains (ViL breaks RLVR plateau).
- **AgentFactory:** Executable code > textual experience for reliable task re-execution. 3-phase: Install → Self-Evolve → Deploy. Portable across Python systems.
- **Native Evolution:** Agents can learn to explore + distill "World Knowledge" without inference-time rewards. Qwen3-14B with world knowledge outperforms unassisted Gemini-2.5-Flash.

---

### Hermes Research
- **GitHub stars: 176K** (June 1) — up from 175K on May 29
- **Latest release: v0.15.2** (May 29) — still no v0.16
- **v0.15.1 hotfix:** Dashboard 401 reload loop, Docker --insecure opt-in, skills catalog 858→19,932 entries
...
- Web search finds only already-documented terms
- Workers deleted May 25 — cannot sync fresh output
- Current wiki entity (updated May 27) remains accurate

---

### Git Commits
- ✅ `autoresearch/`: 3 new techniques + Hermes research
- ✅ `wiki/log.md`: Entry added

**Agentic_Score: Improved** — 3 new techniques documented, knowledge.md updated, wiki log updated, git commits pushed.
