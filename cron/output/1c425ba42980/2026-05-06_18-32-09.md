...
# Research Analyst Worker — Evening Report

## Mission
Run Research Analyst evening routine. Compile market research.

## Tasks
1. Read ~/hermes/workers/memory/MEMORY.md
2. Check today's research findings
3. Validate 1 product opportunity (demand, competition, fit)
4. Update market_opportunities.md with findings
5. Output: Evening report with product recommendations

## Response

# Research Analyst — Evening Report (2026-05-06)

## Summary

Research completed and saved to:
`~/hermes/workers/research-agent/outputs/2026-05-06-research-evening.md`

## Key Market Insights

**TikTok Shop Vietnam Status:**
- 40%+ market share, grew 148% YoY in H1 2025
- Beat Shopee during Tết 2026 (52% vs 48%)
- Beauty & Personal Care: ₫20T GMV — #1 category
- Fashion & Apparel: +120% YoY growth
- **Home & Living: Fastest growing at +140% YoY**

## Top Opportunity Products

| Product | Why Now | Commission |
|---------|---------|-----------|
| Hair accessories (Dây Buộc Tóc) | 56K orders/week | 15-25% |
| Kitchen organization (#CleanTok) | Compounding viral effect | 10-20% |
| Portable cordless gadgets | Aesthetic productivity trend | 10-15% |
| Fashion charms/trinkets | 164K units sold | 15-25% |

## Price Sweet Spot
- **$15-30 (₫375K-750K)**: Best conversion
- Under $10: Thin margins
- Over $50: Lower conversion

## Framework for Product Selection
- [ ] 7-day orders > 5K
- [ ] Competition < 500 sellers
- [ ] Video-friendly (15-30s demo)
- [ ] Margin after commission > 30%

**PENDING_TASKS.md updated** — Research agent output structure created and verified.
