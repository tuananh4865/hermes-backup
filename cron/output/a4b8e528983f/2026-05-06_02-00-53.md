...
## Mission
Tự động chạy AutoResearch loop để cải thiện Hermes Agent mỗi đêm.
...
### 1. Wiki Health Check
- Run `wiki_lint.py --fast`
- Run `wiki_self_heal.py --fix --all`
- Fix any broken links
- Report wiki health status

### 2. Skills Review
- Scan ~/.hermes/skills/
- Identify stale skills (old dates, wrong commands)
- Update if needed
- Report skills status

### 3. AI Agents Research
- Research latest AI agent techniques
- Find new frameworks, tools, methods
- Document in wiki if valuable

### 4. TikTok/Market Research
- Research trending TikTok Shop Vietnam products
- Find new content opportunities
- Gen Z slang updates

---

## PHẦN 2: NEW — SESSION LOG ANALYSIS (THÊM MỚI)

### 5. Session Log Analysis
- Read all Hermes session logs from today
- Check: ~/Library/Application Support/hermes-agent/sessions/
- Extract:
  * **Key decisions** made with Anh
  * **Revenue outcomes** mentioned (products, opportunities)
  * **Learnings** from failures/successes
  * **New opportunities** discussed
  * **Blockers** encountered
  * **Scripts** written or approved
...
Send to: telegram:1132914873:3764041476
